...
export default function App() {
  ...
  const handleRunQA = () => {
    ...
    if (previewData.preview.page_type === "FINANCE" && tieneInventario) {
      setQaStatus("⚠️ QA Alert: Inconsistency detected. Financial pages must not contain inventory.");
    } else {
      setQaStatus("✅ QA Passed: Structure validated with no UX errors or business rule violations.");
    }
  };
